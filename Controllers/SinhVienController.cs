...
namespace BaiThucHanh.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Masinhvien,Tensinhvien,Lophoc")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Masinhvien,Tensinhvien,Lophoc")] SinhVien sinhVien)
        {
